...
.. container:: cell code
   :name: c11721ac-4635-4443-8b5f-329b00c702b1
...
.. container:: cell markdown
   ...
   1 Department of Anatomy, Jagiellonian University, Kraków, Poland 2
   Whiting College of Engineering, Johns Hopkins University, Baltimore,
   MD, United States 3 Harvard University, Cambridge, MA, United States

.. container:: cell markdown
   :name: 1370ab4e-67a5-4962-b418-90da4313b85b

   <div width-100%> Table of Contents

   - `Systematic Review <#systematic-review>`__

     - `Search strategy <#search-strategy>`__
     - `Search <#search>`__
     - `Deduplication <#deduplication>`__
     - `Screening <#screening>`__

   - `Data Collection <./README.ipynb#data-collection>`__
   ...
   .. raw:: html
      ...
      <summary style="font-family:Times New Roman;">
   ...
   Indicate whether a review protocol exists and if and where it can be
   ...
   evidence (e.g., publication bias, selective reporting within
   studies).
   ...
   Provide a brief overview of characteristics of the treatment network.
   This may include commentary on the abundance of trials and randomized
   patients for the different interventions and pairwise comparisons in
   the network, gaps of evidence in the treatment network, and potential
   ...
   assumptions, such as transitivity and consistency. Comment on any
   concerns regarding network geometry (e.g., avoidance of certain
   comparisons).
   ...
   meta-analyses that has been added to guidance from the PRISMA
   statement.

   † Authors may wish to plan for use of appendices to present all
   relevant information in full detail for items in this section.
...
.. container:: cell code
   :name: fb7cf73e-3b47-4c3c-b94b-6974a03838c9
...
.. container:: cell markdown
   ...
   +============+======================================================================================================================================================+======================================================================================================================================================+=====================================================================================================================================================+===+
   | patellar   | `pm_bptb <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//pubmed/pm_bptb.csv>`__\ (*n* | `em_bptb <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//embase/em_bptb.csv>`__\ (*n* | `wos_bptb <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//wos/wos_bptb.csv>`__\ (*n* |   |
   |            | = 190)                                                                                                                                               | = 73)                                                                                                                                                | = 186)                                                                                                                                              |   |
   +------------+------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------+---+
   | hamstring  | `pm_ht <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//pubmed/pm_ht.csv>`__\ (*n* =   | `em_ht <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//embase/em_ht.csv>`__\ (*n* =   | `wos_ht <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//wos/wos_ht.csv>`__\ (*n*     |   |
   |            | 202)                                                                                                                                                 | 97)                                                                                                                                                  | =253)                                                                                                                                               |   |
   +------------+------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------+---+
   | quadriceps | `pm_qt <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//pubmed/pm_qt.csv>`__\ (*n* =   | `em_qt <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//embase/em_qt.csv>`__\ (*n* =   | `wos_qt <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//wos/wos_qt.csv>`__\ (*n* =   |   |
   |            | 165)                                                                                                                                                 | 114)                                                                                                                                                 | 70)                                                                                                                                                 |   |
   +------------+------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------+---+
   | peroneus   | `pm_plt <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//pubmed/pm_plt.csv>`__\ (*n* = | `em_plt <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//embase/em_plt.csv>`__\ (*n* = | `wos_plt <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//wos/wos_plt.csv>`__\ (*n* = |   |
   | longus     | 2)                                                                                                                                                   | 25)                                                                                                                                                  | 4)                                                                                                                                                  |   |
   +------------+------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------+---+
   | Achilles   | `pm_at <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//pubmed/pm_at.csv>`__\ (*n* =   | `em_at <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//embase/em_at.csv>`__\ (*n* =   | `wos_at <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//wos/wos_at.csv>`__\ (*n* =   |   |
   |            | 7)                                                                                                                                                   | 5)                                                                                                                                                   | 10)                                                                                                                                                 |   |
   +------------+------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------+---+
   | tibialis   | `pm_ta <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//pubmed/pm_ta.csv>`__\ (*n* =   | `em_ta <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//embase/em_ta.csv>`__\ (*n* =   | `wos_ta <https://raw.githubusercontent.com/dong-wkim/network_meta-analysis/refs/heads/master/systematic_review/search//wos/wos_ta.csv>`__\ (*n* =   |   |
   |            | 7)                                                                                                                                                   | 3)                                                                                                                                                   | 8)                                                                                                                                                  |   |
   +------------+------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------+---+
...
.. container:: cell markdown
   :name: 313ab029-4543-4d62-9052-0f678a537ccc

   Install ``PyPI`` modules in ``requirements.txt``.

.. container:: cell code
   :name: 7428ca33-ed54-43d7-8872-800872b2d0d7
...
.. container:: cell code
   :name: 19ed74e2-44c5-4224-bd14-47f5fe3185d0
...
.. container:: cell code
   :name: 32daa4dc-d5f9-4ad8-8468-227356840bd7
...
.. container:: cell markdown
   :name: eedfe910-f3b3-487f-879b-6928801e7908

   Exclude certain files from syncing with remote github repository with
   ``gitignore`` file.

.. container:: cell code
   :name: b3db5113-25fd-41c2-8517-2adc1e3d9048
...
.. container:: cell code
   :name: cd54e37c-e452-41f9-8947-cb2d490ca546
...
.. container:: cell code
   :name: 97877c30-8c2c-4ec3-add7-6d9010e147d1
...
.. container:: cell code
   :name: 31a2b060-b6c1-4c61-afbd-0ff9a6e6af0d
...
.. container:: cell markdown
   ...
   **Search strategies** were developed for randomized controlled
   trials: ``pm_bptb.txt``, ``pm_ht.txt``, ``pm_qt.txt``,
   ``pm_plt.txt``, ``pm_at.txt`` and ``pm_ta.txt`` corresponding to
   PubMed search strategies for patellar, hamstring, quadriceps,
   peroneus longus, achilles and tibialis anterior and posterior
   tendones, respectively. From the protocol that was developed, extract
   key terms from the eligibility criteria for inclusion and exclusion
   of studies in order to develop a *search strategy*.

   The search strategies were 'translated' via regular expressions from
   PubMed syntax to Embase and Web of Science syntax, store them into
   the global environment, and save them as plain text files for
   importing and use as queries for search.
   ...
   **Search strategies**
   ...
   .. container:: cell code
      :name: f37b080a-394b-4087-8fd4-74173057ca33
   ...
   .. container:: cell markdown
      ...
      MeSH term Title Title / Abstract Publication Type OR AND NOT Add
   ...
   .. container:: cell code
      :name: 68c55cc5-c650-4c16-91fe-fd246c2afaa2
   ...
   .. container:: cell markdown
      ...
      A01[“``**RCT**<br>rct_pm_bptb``”] B01[“``**RCT**<br>rct_pm_ht``”]
      C01[“``**RCT**<br>rct_pm_qt``”] D01[“``**RCT**<br>rct_pm_plt``”]
      E01[“``**RCT**<br>rct_pm_at``”] F01[“``**RCT**<br>rct_pm_ta``”]

      A02[“reviews_pm_bptb”] B02[“reviews_pm_ht”] C02[“reviews_pm_qt”]
      D02[“reviews_pm_plt”] E02[“reviews_pm_at”] F02[“reviews_pm_ta”]

      A1[“pm_bptb”] B1[“pm_ht”] C1[“pm_qt”] D1[“pm_plt”] E1[“pm_at”]
      F1[“pm_ta”]

      A2[“em_bptb”] B2[“em_ht”] C2[“em_qt”] D2[“em_plt”] E2[“em_at”]
      F2[“em_ta”]

      A3[“wos_bptb”] B3[“wos_ht”] C3[“wos_qt”] D3[“wos_plt”]
      E3[“wos_at”] F3[“wos_ta”]

      G[“pubmed”] H[“embase”] I[“wos”]

      A02 & A01 –> A1 B02 & B01 –> B1 C02 & C01 –> C1 D02 & D01 –> D1
      E02 & E01 –> E1 F02 & F01 –> F1

      A1 & B1 & C1 & D1 & E1 & F1 –> G A2 & B2 & C2 & D2 & E2 & F2 –> H
      A3 & B3 & C3 & D3 & E3 & F3 –> I
   ...
   .. container:: cell markdown
      ...
      The 'gold-standard' or consensus agreement among researchers seems
      to converge on the idea that removal of duplicate records is best
      performed in a process that involves three ordered stages. The
      first is deduplication based on a unique record identifier, such
      as a digital object identifier (DOI) number, PubMed identifier
      (PMID) number, or clinicaltrials.gov (NCT) number. Then, as
      according to as described for the second stage, the remaining
      records were deduplicated based on a concatenated column
      consisting of the title, author, and year. The title was
      standardized by converting to sentence case, and punctuation marks
      and white spaces were removed. The character length was decreased
      to 50. For the authors column, the last name of the first author
      was chosen to be used. For the year of publication, the year was
      extracted from the date of publication in the electronic version
      of the journal and converted into a string data structure.
   ...
   .. container:: cell markdown
      ...
      `screening <#screening>`__ \| `data
      collection <#data-collection>`__ \|
   ...
   .. container:: cell markdown
      ...
      forms design and creation, then data collection, also known as
      data extraction.
