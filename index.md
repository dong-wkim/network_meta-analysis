...
- [Data Collection](./README.ipynb#data-collection)
  - [Forms](./ipywidgets.ipynb#ipywidgets)
...
:::: {#9c00985a-004a-43a3-b8a0-730303f4077a .cell .code execution_count="24"}
``` python
import numpy as np
...
::: {.output .display_data}
![](982d2e3f21989a52d6ad0dcbe538434e055d38b2.png)
:::
::::

::: {#fb7cf73e-3b47-4c3c-b94b-6974a03838c9 .cell .code execution_count="27"}
``` python
...
::: {#7428ca33-ed54-43d7-8872-800872b2d0d7 .cell .code}
``` python
!pandoc -f docx -t markdown_strict+pipe_tables "PRISMA NMA checklist.docx" -o prisma-nma.md 
```
:::

::: {#19ed74e2-44c5-4224-bd14-47f5fe3185d0 .cell .code}
``` python
...
::: {#b3db5113-25fd-41c2-8517-2adc1e3d9048 .cell .code}
``` python
ignore = f""".venv/
*/*.gsheet
*/*.gdoc"""
...
::: {#ee98e7bc-08ac-45ca-b0fd-bacd14a99af3 .cell .code}
``` python
import subprocess
import sys
import os
...
::: {#6b17992c-d672-4e73-a649-bda3ed872e39 .cell .code execution_count="3"}
``` python
import pandas as pd
import os
from pathlib import Path
...
::: {#def2aff0-5673-4673-a151-304dcbb0d2f7 .cell .code}
``` python
root = os.getcwd()
folders = {
"systematic_review": f"{root}/systematic_review",
...
:::: {#31a2b060-b6c1-4c61-afbd-0ff9a6e6af0d .cell .code execution_count="28"}
``` python
...
::: {.output .display_data}
``` json
{"model_id":"90bc73de17944000a1b67fc18242ebf7","version_major":2,"version_minor":0}
```
:::
::::
...
<details>
    ...
    <summary><h2 align="center" style="font-family:Times New Roman;font-variant: small-caps;">Search Strategy</h2></summary>

`<br>`{=html} `<a id="search-strategy">`{=html}`</a>`{=html}
...
:::: {#c87f8e5c-7b36-4ad0-8bf0-0bd897221065 .cell .code execution_count="32"}
``` python
import ipywidgets as widgets
...
::: {.output .display_data}
``` json
{"model_id":"8068ec22a5d44ffa8c6a4912d3981d7d","version_major":2,"version_minor":0}
```
:::
::::
...
:::: {#68c55cc5-c650-4c16-91fe-fd246c2afaa2 .cell .code execution_count="34"}
``` python
# Version 1.0
...
::: {.output .error ename="IndentationError" evalue="unexpected indent (4152969777.py, line 9)"}
      Cell In[34], line 9
        field = input("Enter the field type: ")
        ^
...
:::: {#1fda7696-1363-48ba-8834-abf37cf86cb9 .cell .code execution_count="30" slideshow="{\"slide_type\":\"\"}" tags="[]"}
``` python
...
::: {.output .error ename="NameError" evalue="name 'ssl' is not defined"}
    ------------------------------------------------------------------
    NameError                        Traceback (most recent call last)
    Cell In[30], line 1
    ----> 1 ssl._create_default_https_context = lambda: ssl.create_default_context(
          2     cafile=certifi.where()
          3 )
...
::::: {#c5865181-766d-478a-8a8d-81d5a275c3ed .cell .code execution_count="14"}
``` python
import pandas as pd
import mermaid
import os
...
::: {.output .stream .stdin}
    Enter the column for which to deduplicate based on:  doi
:::

::: {.output .error ename="OSError" evalue="Cannot save file into a non-existent directory: '('G:\\My Drive\\network_meta-analysis\\systematic_review\\deduplication',)'"}
    ------------------------------------------------------------------
    OSError                          Traceback (most recent call last)
    Cell In[14], line 50
         38 results = {"records": len(df),  
         39 "nulls": len(df_nulls), 
         40 "non_nulls": len(df_non_nulls), 
       (...)     46 "deduplicated": len(df_deduplicated)
         47 }
         49 output_file_name = f"{deduplication}/deduplicated.csv"
    ---> 50 df_nulls.to_csv(output_file_name.replace('deduplicated','nulls'), index = False)
         51 df_deduplicated.to_csv(output_file_name, index = False)
         52 df_removed.to_csv(output_file_name.replace('deduplicated','duplicates_removed'), index = False)

    File C:\tools\Anaconda3\Lib\site-packages\pandas\util\_decorators.py:333, in deprecate_nonkeyword_arguments.<locals>.decorate.<locals>.wrapper(*args, **kwargs)
    ...
    File C:\tools\Anaconda3\Lib\site-packages\pandas\core\generic.py:3989, in NDFrame.to_csv(self, path_or_buf, sep, na_rep, float_format, columns, header, index, index_label, mode, encoding, compression, quoting, quotechar, lineterminator, chunksize, date_format, doublequote, escapechar, decimal, errors, storage_options)
    ...
    File C:\tools\Anaconda3\Lib\site-packages\pandas\io\formats\format.py:1014, in DataFrameRenderer.to_csv(self, path_or_buf, encoding, sep, columns, index_label, mode, compression, quoting, quotechar, lineterminator, chunksize, date_format, doublequote, escapechar, errors, storage_options)
    ...
    File C:\tools\Anaconda3\Lib\site-packages\pandas\io\formats\csvs.py:251, in CSVFormatter.save(self)
        247 """
    ...
    File C:\tools\Anaconda3\Lib\site-packages\pandas\io\common.py:749, in get_handle(path_or_buf, mode, encoding, compression, memory_map, is_text, errors, storage_options)
    ...
    File C:\tools\Anaconda3\Lib\site-packages\pandas\io\common.py:616, in check_parent_directory(path)
    ...
    OSError: Cannot save file into a non-existent directory: '('G:\My Drive\network_meta-analysis\systematic_review\deduplication',)'
:::
:::::
...
No = widgets.Button(value = "No", description = "Yes")
...
:::: {#b42fd8ae-99b6-4e3c-bf9a-13255c408ceb .cell .code execution_count="39"}
``` python
import ipywidgets as widgets
...
::: {.output .error ename="NameError" evalue="name 'IntSlider' is not defined"}
    ------------------------------------------------------------------
    NameError                        Traceback (most recent call last)
    Cell In[39], line 3
