...
def forms():
    ...
    m = widgets.SelectMultiple(options = [
        ...
        'PLT', 
        'AT', 
        'TA'], value = ["BPTB"], description = "subgroup(s)", layout = {"width": "90%"})
    ...
    o = widgets.SelectMultiple(options = [
        ...
        'Lachman',
        'Graft rupture'
    ], value = ("",), description = "outcome(s)", layout = {"width": "90%"})
    ...
    def save_values(change):    
        ...
        df.loc[df["id"] == a.value, "outcome(s)"] = ", ".join(o.value)
